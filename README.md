...
### Specificatii proiect
  ...
  **Reviewer**
    ...
    -Trimite comentarii și recomandări autorului
...
**Backend**
    ...
    -Crearea API-urilor pentru conferințe, articole și revieweri
    -Implementarea algoritmului de alocare a reviewerilor
...
**Frontend**
  ...
  _2.6.Implementarea finală și livrarea_
    ...
    -Verificarea completă a tuturor funcționalităților
    -Pregătirea unei versiuni stabile a aplicației
